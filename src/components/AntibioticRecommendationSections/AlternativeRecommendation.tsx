...
interface AlternativeRecommendationProps {
...
export const AlternativeRecommendation: React.FC<AlternativeRecommendationProps> = ({ 
  recommendation, 
  selectedProduct,
  index,
  isActive
  ...
  return (
    <Card className="p-6 bg-white/50 backdrop-blur-sm border-mint-200">
      <div className="flex items-center gap-2 mb-4">
        ...
        <h3 className="text-2xl font-semibold text-gray-900">Alternative Option {index + 1}</h3>
      </div>
