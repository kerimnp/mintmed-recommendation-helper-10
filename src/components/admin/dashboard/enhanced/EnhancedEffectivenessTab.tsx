...
const patientOutcomes = [
  { category: 'Complete Recovery', value: 78, fill: '#22c55e' },
  { category: 'Partial Recovery', value: 15, fill: '#f59e0b' },
  { category: 'No Improvement', value: 5, fill: '#ef4444' },
  { category: 'Adverse Events', value: 2, fill: '#dc2626' }
];
...
export const EnhancedEffectivenessTab: React.FC = () => {
