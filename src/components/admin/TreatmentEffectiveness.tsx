      ...
      <Card className="border border-slate-200 dark:border-slate-700 shadow-sm">
        <CardHeader className="pb-3">
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
            <CardTitle className="text-xl">Treatment Effectiveness Analysis</CardTitle>
          ...
          <CardDescription>
            Analyzing treatment effectiveness for {infectionType.charAt(0).toUpperCase() + infectionType.slice(1)} infections
          </CardDescription>
        </CardHeader>
        <CardContent>
          <Card className="mb-6 border border-slate-100 dark:border-slate-800 shadow-sm">
            <CardHeader className="pb-2">
              <div className="flex justify-between">
                <CardTitle className="text-lg">Effectiveness Trends Over Time</CardTitle>
