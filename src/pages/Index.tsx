...
const Index = () => {
  ...
  const features = [{
    ...
    description: language === "en" ? "Get evidence-based antibiotic recommendations tailored to each patient's unique profile." : "Dobijte preporuke antibiotika temeljene na dokazima i prilagođene jedinstvenom profilu svakog pacijenta."
  }, {
    icon: <Microscope className="h-12 w-12 text-green-500" />,
    title: language === "en" ? "Clinical Precision" : "Klinička Preciznost",
    description: language === "en" ? "Factor in allergies, renal function, and comorbidities for safer prescribing." : "Uzmite u obzir alergije, bubrežnu funkciju i komorbiditete za sigurnije propisivanje."
  }, {
    icon: <Globe className="h-12 w-12 text-purple-500" />,
    title: language === "en" ? "Regional Adaptation" : "Regionalna Prilagodba",
    description: language === "en" ? "Recommendations consider local resistance patterns for optimal outcomes." : "Preporuke uzimaju u obzir lokalne obrasce otpornosti za optimalne ishode."
  }, {
    icon: <BookOpen className="h-12 w-12 text-amber-500" />,
    title: language === "en" ? "Continuous Learning" : "Kontinuirano Učenje",
    description: language === "en" ? "Access educational resources to stay updated with the latest clinical guidelines." : "Pristupite obrazovnim resursima kako biste bili u toku s najnovijim kliničkim smjernicama."
  }];
  const sections = [{
    icon: <Hospital className="h-14 w-14 text-blue-600" />,
    title: language === "en" ? "Clinical Decision Support" : "Podrška Kliničkom Odlučivanju",
    description: language === "en" ? "Our system integrates the latest clinical guidelines with patient-specific data to provide personalized antibiotic recommendations that optimize treatment outcomes while minimizing risks." : "Naš sustav integrira najnovije kliničke smjernice s podacima specifičnim za pacijenta kako bi pružio personalizirane preporuke antibiotika koje optimiziraju ishode liječenja uz minimiziranje rizika."
  }, {
    icon: <HeartPulse className="h-14 w-14 text-red-500" />,
    title: language === "en" ? "Patient Safety Focus" : "Fokus na Sigurnost Pacijenata",
    description: language === "en" ? "Every recommendation accounts for patient allergies, drug interactions, renal/hepatic function, and other critical factors to ensure the safest possible antibiotic regimen for each individual." : "Svaka preporuka uzima u obzir alergije pacijenta, interakcije lijekova, bubrežnu/jetrenu funkciju i druge kritične faktore kako bi se osigurao najsigurniji mogući režim antibiotika za svakog pojedinca."
  }, {
    icon: <GraduationCap className="h-14 w-14 text-green-600" />,
    title: language === "en" ? "Educational Resources" : "Obrazovni Resursi",
    description: language === "en" ? "Beyond recommendations, we provide comprehensive educational materials to help clinicians stay current with evolving best practices in antibiotic stewardship and infectious disease management." : "Osim preporuka, pružamo sveobuhvatne obrazovne materijale kako bismo pomogli kliničarima da ostanu u toku s evolucijom najboljih praksi u upravljanju antibioticima i zaraznim bolestima."
  }];
  return <>
      <Helmet>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex items-center justify-between h-16">
              ...
              <div className="flex items-center gap-2 sm:gap-4">
                <Button variant="ghost" size="icon" onClick={() => setTheme(theme === "light" ? "dark" : "light")} className="rounded-full hover:bg-gray-100/80 dark:hover:bg-gray-800/80">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                ...
                duration: 0.6
                  ...
                  <p className="text-xl text-gray-600 dark:text-gray-300">
                    {language === "en" ? "Horalix combines clinical expertise with advanced AI to deliver personalized antibiotic recommendations that help optimize patient outcomes." : "Horalix kombinira kliničku stručnost s naprednom umjetnom inteligencijom za pružanje personaliziranih preporuka antibiotika koje pomažu u optimizaciji ishoda pacijenata."}
                  </p>
            ...
            <div className="max-w-7xl mx-auto">
              <div className="text-center mb-16">
                ...
                <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
                  {language === "en" ? "Horalix combines clinical expertise with advanced technology to provide accurate, personalized antibiotic recommendations." : "Horalix kombinira kliničku stručnost s naprednom tehnologijom za pružanje točnih, personaliziranih preporuka antibiotika."}
                </p>
              </div>
            ...
            <div className="max-w-5xl mx-auto text-center">
              ...
              once: true
                ...
                <h2 className="text-3xl font-bold bg-gradient-to-r from-gray-900 to-gray-600 dark:from-white dark:to-gray-400 bg-clip-text text-transparent">
                  {language === "en" ? "Ready to transform your antibiotic prescribing practice?" : "Spremni za transformaciju vaše prakse propisivanja antibiotika?"}
                </h2>
                <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
                  {language === "en" ? "Join thousands of healthcare professionals who trust Horalix to support their clinical decision-making." : "Pridružite se tisućama zdravstvenih djelatnika koji vjeruju Horalixu u podršci njihovom kliničkom odlučivanju."}
                </p>
                <Link to="/advisor">
